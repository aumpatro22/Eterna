      ...
      <div className="absolute bottom-6 right-6 bg-white border-[3px] border-ink p-4 wobbly-sm shadow-hard pointer-events-auto flex flex-col gap-4 select-none animate-bounce">
        ...
        <div className="flex gap-3 justify-center">
          <button
            ...
            className={`w-8 h-8 rounded-full border-2 border-ink focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ink ${color === '#ff4d4d' ? 'ring-2 ring-offset-2 ring-marker' : ''}`}
          ...
          <button
            ...
            className={`w-8 h-8 rounded-full border-2 border-ink focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ink ${color === '#2d5da1' ? 'ring-2 ring-offset-2 ring-pen' : ''}`}
          ...
          <button
            ...
            className={`w-8 h-8 rounded-full border-2 border-ink focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ink ${color === '#2d2d2d' ? 'ring-2 ring-offset-2 ring-ink' : ''}`}
        ...
        <div className="flex gap-2 justify-center text-sm font-patrick border-t-2 border-dashed border-ink/30 pt-3">
          <button
            ...
            className={`px-2 py-0.5 border-[2px] border-ink wobbly-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ink ${lineWidth === 2 ? 'bg-ink text-white' : 'bg-white'}`}
          ...
          <button
            ...
            className={`px-2 py-0.5 border-[2px] border-ink wobbly-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ink ${lineWidth === 5 ? 'bg-ink text-white' : 'bg-white'}`}
          ...
          <button
            ...
            className={`px-2 py-0.5 border-[2px] border-ink wobbly-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ink ${lineWidth === 10 ? 'bg-ink text-white' : 'bg-white'}`}
